...
<div class="right-div">
<h3>Pay online on this mpar@pay.com</h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class ="input-style" type="text" name="mobileNumber" value ="<%=rs2.getString(3) %>" placeholder="Enter mobileNumber" required>
